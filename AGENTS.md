...
Recipe-local skills remain owned by their recipe and follow the closest recipe-level `AGENTS.md`.
Do not move recipe implementation guidance into a repository-level portable skill.
