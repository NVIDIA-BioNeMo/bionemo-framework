    ...
    <div style={styles.overlay} onClick={(e) => { if (e.target === e.currentTarget) onClose() }}>
      <div style={styles.page}>
              ...
              {visibleExamples.map((ex, i) => (
                <div key={i} style={styles.example}>
                  <div style={styles.exampleMeta}>
                    <span>
                      <strong style={{ color: 'var(--text-heading)' }}>{getRegionLabel(ex)}</strong>
                    </span>
        ...
        <div style={{ borderTop: '1px solid var(--border-light)', paddingTop: '16px', marginTop: '16px' }}>
          ...
          <div
            title="Annotation overlay (RefSeq, Rfam, JASPAR) — coming in v2"
            style={{
        ...
        <div style={{ paddingTop: '16px' }}>
          ...
          <div
            title="Conservation track (phyloP) — coming in v2"
            style={{
              border: '1px dashed var(--border)',
              borderRadius: '6px',
              padding: '24px',
