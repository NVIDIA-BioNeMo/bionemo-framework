...
export default function App({ title = "Evo 2 SAE Feature Explorer (Mockup)", subtitle = "Synthetic data — not from a real SAE run" }) {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={{ ...styles.header, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <p style={styles.subtitle}>Evo 2 SAE Feature Explorer (Mockup)</p>
        </div>
