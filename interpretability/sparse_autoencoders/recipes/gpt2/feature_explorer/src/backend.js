...
// Text mode: pass the raw text straight through. (Named cleanDNA for legacy import
// compatibility; the GPT-2 build annotates/steers natural-language text, so we must NOT
// strip to A/C/G/T/N — that gutted "LOOK AT THIS TEXT" down to "ATTTT" before sending.)
