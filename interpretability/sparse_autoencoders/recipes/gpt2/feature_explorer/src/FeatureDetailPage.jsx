...
export default function FeatureDetailPage({ feature, examples, onClose }) {
  ...
  useUserLabels()  // re-render if this feature is renamed in any tab/window

  const freq = feature.activation_freq || 0
  const maxAct = feature.max_activation || 0
  const description = userLabel(feature.feature_id) || feature.description || feature.label || `Feature ${feature.feature_id}`
      ...
      <div style={styles.page}>
        ...
        {feature.logo_path && (
          <div style={styles.section}>
            <div style={styles.sectionTitle}>Token Context</div>
            <img
        ...
        <div style={styles.section}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
            <div style={styles.sectionTitle}>Top Activating Texts</div>
