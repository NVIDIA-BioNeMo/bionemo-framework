...
| Reward gaming, missing evidence, or unavailable tools produces a misleading pass.                              | Use adversarial fixtures, bounded independent objectives, support telemetry, online/final alignment checks, and indeterminate/fail-closed outcomes when required evidence or dependencies are missing.                                                              |
