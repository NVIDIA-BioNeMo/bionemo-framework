...
def _rewrite_relative_links(
    ...
    * Hidden recipe paths, which are not published in the docs tree, are
      rewritten to their canonical GitHub locations.
    ...
    def _make_rewriter(ref_dir: str, rendered_links: bool = False):
        ...
        def _rewrite(rel_path: str) -> str:
            ...
            for recipe_root, section in recipe_roots.items():
                ...
                if any(part.startswith(".") for part in rel_to_recipe_root.parts):
