...
Before you begin using the BioNeMo Recipes, ensure the hardware and software prerequisites outlined below are
met.

## Hardware Prerequisites

The BioNeMo Recipes is compatible with environments that have access to NVIDIA GPUs. `bfloat16` precision requires an
...
The BioNeMo Recipes is supported on x86 Linux systems.
