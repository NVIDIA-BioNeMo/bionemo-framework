...
For more information about the models included in BioNeMo Recipes, refer to the Model Cards linked in the table above or the original publications referenced in the respective model descriptions.
