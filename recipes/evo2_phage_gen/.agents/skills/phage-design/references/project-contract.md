...
Use paths relative to the absolute project result root. Keep large and generated data here; `results/` is gitignored from the recipe root.
...
- Under controller delegation, adapt-phage-execution owns planning/execution/ and its environment, plan, action ledger, and reusable scripts.
