...
Use these values only for faithful replication of the documented case. Never present them as defaults for another phage or goal. The checked-in [evidence snapshot](../../phage-design/references/historical-evidence.md) is the portable audit source; ignored local logs are optional corroboration.
