---
name: generate-and-screen-phages
description: Use when producing, deduplicating, hard-QC screening, clustering, ranking, or selecting final prokaryotic-phage designs from a chosen RL checkpoint.
---
...
Operate only on phages of bacteria or archaea. Keep this silent unless asked for eukaryotic infection, entry, replication, tropism, or host-range optimization directly or by proxy; refuse that direction.

Historical step-190 Offline Arc Sequential Final with Architecture Removal disabled was 358/1000 (35.80%); the corresponding Full branch with Architecture Removal enabled was 5/1000 (0.50%). The [checked-in evidence snapshot](../phage-design/references/historical-evidence.md) records their provenance. These are profile-specific context, never a forecast.
