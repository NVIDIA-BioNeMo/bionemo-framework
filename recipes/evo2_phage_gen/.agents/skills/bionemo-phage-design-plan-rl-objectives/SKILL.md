...
1. Record reference phage/hash, target host, desired change, protected traits, ordering budget, acceptable uncertainty, and exact RL prompt-manifest derivation. If several SFT runs exist, surface them and ask whether to reuse one or train anew.
