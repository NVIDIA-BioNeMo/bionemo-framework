...
\left(1 - p_{\mathrm{eff}}\right)^k = 0.053
...
\left(1 - p_{\mathrm{eff}}\right)^k = V_{\mathrm{observed}} \tag{1}
...
\operatorname{Uplift}(k) = \frac{\Pr_{\mathrm{model}}(\mathrm{viable}\mid k)}{\Pr_{\mathrm{base}}(\mathrm{viable}\mid k)} \tag{2}
...
\operatorname{Uplift}(k) = \frac{V_{\mathrm{observed}}}{(1-p_{\mathrm{lethal}})^k} \tag{3}
...
w = \exp(-s_{\mathrm{del}}k_d + s_{\mathrm{ben}}k_b) \tag{4}
...
$$
p_{\mathrm{del}} \in \{0.3,0.5,0.7\}, \tag{10}
$$  with *p*<sub>ben</sub> = 10<sup>*−*3</sup> fixed and $$
p_{\mathrm{neu}} = 1-p_{\mathrm{del}}-p_{\mathrm{ben}}. \tag{11}
...
$$
s_{\mathrm{del}} \in \{0.1,0.2,0.5\},\quad s_{\mathrm{ben}} \in \{0.05,0.1,0.2\}. \tag{12}
