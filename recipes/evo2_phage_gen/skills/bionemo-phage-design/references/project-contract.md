...
sft_lineage:
  ...
  checkpoint:
    ...
    content_sha256: "..."
    manifest_sha256: "..."
  checkpoint_stage_binding_evidence: {artifact_path: "...", artifact_sha256: "..."}
  base_model: {provider: "...", public_id: "...", version: "...", format: "...", content_sha256: "..."}
  training_data:
    dataset_manifest_sha256: "..."
    leakage_controlled_split_manifest_sha256: "..."
  implementation: {resolved_config_sha256: "...", source_state_sha256: "..."}
  selection:
...
This block matches the schema-4 objective contract. An immutable manifest reference may satisfy it
only when its hash verifies and its contents provide every field. General evidence or a checkpoint
path cannot substitute. The detailed operator validation requirements in
../../bionemo-phage-design-operate-nemo-rl/references/lineage-contract.md also apply. Reject incomplete
lineage rather than guessing. A different project root is valid when every identity and checksum resolves.
