...
# This file is copied from: recipes/evo2_megatron/src/bionemo/evo2/models/megatron/hyena/hyena_model.py
...
class HyenaModel(LanguageModule):
    ...
    def __init__(
        ...
        hyena_init_method: str | None = None,
        hyena_output_layer_init_method: str | None = None,
        remove_activation_post_first_layer: bool = True,
        add_attn_proj_bias: bool = True,
        pg_collection: Optional[ProcessGroupCollection] = None,
        vp_stage: Optional[int] = None,
    ) -> None:
        """Initialize the megatron HyenaModel."""
