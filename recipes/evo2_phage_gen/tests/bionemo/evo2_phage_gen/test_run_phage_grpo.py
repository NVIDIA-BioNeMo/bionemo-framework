...
def test_register_recipe_extensions_registers_evo2_vllm_worker(monkeypatch) -> None:
    ...
    _require(
        ACTOR_ENVIRONMENT_REGISTRY[worker_fqn] == PY_EXECUTABLES.SYSTEM,
        "Evo2 vLLM worker did not inherit the verified recipe Python environment",
    )
